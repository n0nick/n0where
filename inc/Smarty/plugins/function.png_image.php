 ...
 *
 * 18.11.2004 Some alteration by n0nick <sagiem@gmail.com>
 * -------------------------------------------------------------
 */
...
function smarty_function_png_image($params, &$smarty)
{
  ...
  if (empty($width))
	...
	if ($PNGcompliantAgent)
      ...
      $html = '<div '.$extra.' style="direction: ltr; height: '.$height.'px; width: '.$width.'px; filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''.$src.'\', sizingMethod=\'scale\')"></div>';
